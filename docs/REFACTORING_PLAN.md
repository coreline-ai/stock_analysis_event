...
이 문서는  
**기존 DEEPSTOCK 프로젝트(https://github.com/ygwyg/DEEPSTOCK)를  
...
- GitHub Repository  
  https://github.com/ygwyg/DEEPSTOCK

### 1.2 현재 DEEPSTOCK의 성격 요약

기존 DEEPSTOCK는 다음 성격을 가진 시스템이다:
...
기존 DEEPSTOCK에서 가장 큰 문제는 다음과 같다 Confirm:
...
## 5. 리팩토링 후 DEEPSTOCK의 정체성

리팩토링 이후 DEEPSTOCK는 다음과 같은 시스템이 된다:
